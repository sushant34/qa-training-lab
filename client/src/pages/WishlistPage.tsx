          ...
          {items.map(item => (
            <div key={item.id} className="card hover:shadow-md transition-shadow">
              ...
              <div className="space-y-2">
                <span className="inline-block px-2 py-0.5 text-xs font-medium bg-indigo-50 text-indigo-600 rounded-full">{item.category}</span>
                ...
                <div className="flex gap-2 pt-2">
                  ...
                  <button onClick={() => handleRemove(item.product_id)} className="btn btn-outline btn-sm text-red-500 hover:bg-red-50 hover:border-red-200">
                    <Trash2 size={14} />
                  </button>
                </div>
              </div>
